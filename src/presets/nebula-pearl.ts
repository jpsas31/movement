...
//
// Shape + motion: Magellan warp + comp + Flexi shape
// Tier matches global Y (viz-intensity): mild / normal / hot equation sets.
...
export function createNebulaPearl(aggression: VizIntensity) {
  ...
  const frame_eqs_str =
    ...
    `a.q10=${qca}*a.q10+${qcb}*a.wr;a.q11=${qca}*a.q11+${qcb}*a.wb;a.q12=${qca}*a.q12+${qcb}*a.wg;` +
    "a.q10=Math.min(1,a.q10*1.12+0.05);a.q11=Math.min(1,a.q11*1.12+0.05);a.q12=Math.min(1,a.q12*1.12+0.05);" +
    "a.warp=0;";
